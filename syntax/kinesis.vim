...
syn keyword kinesisModifier lalt lctrl lshift ralt rctrl cshift contained
syn match kinesisModifier /lalt\|lctrl\|lshift\|ralt\|rctrl\|cshift\|win/ contained
syn match kinesisPlusMinus /[+-]/
syn match kinesisModifier /[+-]\(lalt\|lctrl\|lshift\|lwin\|ralt\|rctrl\|cshift\|rwin\)/ contained contains=kinesisPlusMinus
